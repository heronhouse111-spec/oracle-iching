/**
 * Blog 內容資料 — 中英雙語 SEO 文章
 *
 * 結構為純資料,/blog 與 /blog/[slug] 兩支 Server Component 直接讀。
 * 之後若要改用 MDX / CMS,只要把 BlogPost.bodyZh / bodyEn 改成檔案路徑即可。
 *
 * 寫作原則:
 *   - 每篇 ~300 字中文 + ~200 字英文
 *   - 標題務必含長尾關鍵字(「塔羅 牌陣」「AI 塔羅 準嗎」等)
 *   - 開頭一段話直接回答查詢者的問題,符合 Google Featured Snippet 取材習慣
 *   - 段落間留呼吸,避免一塊巨文
 *   - 不放外連,只連回站內(/tarot/cards、/tarot-spread、/yes-no、/daily、/)
 */
...
export interface BlogPost {
  ...
  excerptZh: string;
  excerptEn: string;
  /** ISO date,sitemap & metadata 用 */
  publishedAt: string;
  /** 主題分類(目前未用,留給未來 filter) */
  category: "intro" | "spread" | "card" | "topic" | "ai";
  /** 文章主體(用簡單的 paragraph 陣列,渲染時每段一個 <p>;支援 ## 開頭視為 h2) */
  bodyZh: string[];
  bodyEn: string[];
}
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    titleZh: "易經 vs 塔羅:該選哪個占卜?",
    titleEn: "I Ching vs Tarot — Which Should You Choose?",
    excerptZh: "東方系統重時機與位置,西方塔羅重故事與情感。一篇文看懂兩者擅長的問題。",
    excerptEn: "Eastern reading favours timing and position; Western tarot favours story and emotion.",
  ...
  {
    slug: "is-ai-tarot-accurate",
    titleZh: "AI 塔羅準嗎?2026 年深度分析",
    titleEn: "Is AI Tarot Accurate? A 2026 Deep Look",
    excerptZh: "AI 不會「靈動」、但能在牌義詮釋的廣度與一致性勝過半數人類牌手。重點是怎麼問。",
    excerptEn: "AI doesn't channel — but on breadth and consistency it beats half of human readers. The leverage is the question.",
  ...
  {
    slug: "78-tarot-cards-quick-reference",
    titleZh: "78 張塔羅牌牌意速查 — 完整入門",
    titleEn: "78 Tarot Cards Quick Reference",
    excerptZh: "從愚者到世界,從聖杯一到錢幣國王,一張表記住核心關鍵字。",
    excerptEn: "From the Fool to the World, from Ace of Cups to King of Pentacles — one table for the essentials.",
  ...
  },
  {
    ...
    titleZh: "三牌時間軸 — 最經典的入門牌陣",
    titleEn: "Three-Card Timeline — The Classic Starter Spread",
    excerptZh: "過去-現在-未來,三張牌看出一件事的脈絡。新手第一個該學的牌陣。",
    excerptEn: "Past-present-future. Three cards, one arc. The first spread every reader should learn.",
  ...
  {
    slug: "celtic-cross-real-world-guide",
    titleZh: "凱爾特十字實戰指南 — 十張牌做大命題",
    titleEn: "Celtic Cross Real-World Guide — Ten Cards for Big Questions",
    excerptZh: "塔羅最完整的牌陣。十個位置看一個複雜命題的全景。",
    excerptEn: "Tarot's most complete spread. Ten positions, panoramic view of one complex matter.",
  ...
  {
    slug: "two-options-spread-when-to-use",
    titleZh: "二選一牌陣 — 卡在兩條路時用",
    titleEn: "Two Options Spread — When You're Stuck Between Paths",
    excerptZh: "不是預言哪條路會贏,而是看見每條路的本質與課題。",
    excerptEn: "Not prophesying which wins. Showing each path's nature and lesson.",
  ...
  {
    slug: "love-question-how-to-ask",
    titleZh: "感情占卜該怎麼問問題?",
    titleEn: "How to Phrase Love Questions for Tarot",
    excerptZh: "「他喜歡我嗎?」是壞問題。換個問法,塔羅會給你完全不同的洞見。",
    excerptEn: "\"Does he like me?\" is a poor question. Reframe it and tarot opens up.",
  ...
  {
    slug: "career-tarot-common-cards",
    titleZh: "事業占卜常見牌組與訊號",
    titleEn: "Career Tarot — Common Cards and Signals",
    excerptZh: "看到這些牌就要小心:錢幣三的合作、寶劍五的鬥爭、權杖騎士的衝動。",
    excerptEn: "Watch these cards: 3 of Pentacles' collab, 5 of Swords' fight, Knight of Wands' rush.",
  ...
  {
    slug: "money-tarot-beginner",
    titleZh: "財運占卜入門 — 怎麼問才不會被自己騙",
    titleEn: "Money Tarot for Beginners — Asking Without Self-Deception",
    excerptZh: "想知道哪檔股票會漲?塔羅給不了你。但它能告訴你你的財富心智在哪。",
    excerptEn: "Which stock will pump? Tarot can't say. But it can tell you where your money mind sits.",
  ...
  {
    slug: "daily-card-ritual",
    titleZh: "每日一卡的儀式感 — 為什麼有效",
    titleEn: "The Ritual of the Daily Card — Why It Works",
    excerptZh: "每天 30 秒,讓塔羅成為你內在天氣預報。",
    excerptEn: "30 seconds a day. Make tarot your inner weather report.",
