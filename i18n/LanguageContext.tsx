 ...
 *
 * 設計取捨:
 * - `locale` 仍維持 "zh" | "en" —— 全庫數十處 `locale === "zh"` 不動,
 *   Supabase `divinations.locale` 欄位也不用擴。
...
const STORAGE_LOCALE = "preferred_locale"; // "zh" | "en"
const STORAGE_ZH_VARIANT = "preferred_zh_variant"; // "TW" | "CN"

/** 依 navigator.languages 推斷訪客預設語系,非中文圈直接 EN。 */
