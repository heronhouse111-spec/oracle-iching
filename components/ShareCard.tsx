...
const ShareCard = forwardRef<HTMLDivElement, Props>(function ShareCard(
  ...
  const hasRelating = relatingHexagram && relatingLines && relatingLines.length === 6;
  const aiSummary = summarizeReading(aiReading, hasRelating ? 150 : 200);
    ...
    >
      ...
      >
        ...
        >
          ...
          {hasRelating && relatingHexagram && relatingLines && (
            <>
        ...
        >
          <span style={{ fontSize: 16, color: "rgba(192,192,208,0.5)" }}>
