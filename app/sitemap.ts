...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/iching/yes-no`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/iching/daily`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${BASE_URL}/iching/methods`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/iching/two-options`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/iching/hexagrams`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
