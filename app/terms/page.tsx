        ...
        {isZh ? (
          ...
          >
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={paragraphStyle}>
                本平台所使用之塔羅牌圖像採用 Rider-Waite-Smith 公共領域版本
                (Pamela Colman Smith, 1909),依其公共領域授權自由使用。
                其餘介面、文字、程式碼、商標等均為鷺居國際或其授權方所有,
                未經書面同意不得重製、散布或商業利用。
              </p>
            </section>
          ...
          >
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={paragraphStyle}>
                Tarot images use the public-domain Rider-Waite-Smith deck
                (Pamela Colman Smith, 1909). All other interface elements,
                text, code, and trademarks belong to Heronhouse or its
                licensors; reproduction, distribution, or commercial use is
