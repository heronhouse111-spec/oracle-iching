...
values
  ...
  ('TAROT_5_CARD',   10, '愛情十字 5 牌',       'Love Cross 5-card',
   '5 張塔羅牌陣 + AI 600 字解讀',                  '5-card spread + AI 450-word reading',           'tarot', 80),
  ('TAROT_10_CARD',  20, '凱爾特十字 10 牌',    'Celtic Cross 10-card',
   '10 張完整塔羅牌陣 + AI 1000 字解讀',            '10-card complete spread + AI 750-word reading', 'tarot', 90),
